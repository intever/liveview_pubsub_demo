defmodule LiveviewPubsubDemoWeb.Router do
  use LiveviewPubsubDemoWeb, :router

  import LiveviewPubsubDemoWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {LiveviewPubsubDemoWeb.LayoutView, :root}
  ...
  # scope "/api", LiveviewPubsubDemoWeb do
  #   pipe_through :api
  # end
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: LiveviewPubsubDemoWeb.Telemetry
    end
  end
